...
import { Button, Card, Empty, Field, Loading, ScreenHeader, nativeStyles } from "@/native/ui";
...
export function HistoryScreen() {
  ...
  if (isLoading) return <View style={nativeStyles.screen}><ScreenHeader title="History" /><Loading /></View>;
  return <View style={nativeStyles.screen}><ScreenHeader title="Cooking History" /><ScrollView contentContainerStyle={nativeStyles.scroll}>
