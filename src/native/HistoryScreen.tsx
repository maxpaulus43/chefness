          ...
          <SwipeActionRow key={entry.id} onDelete={() => confirmDelete(entry)}>
            <Card>
              ...
              <View style={nativeStyles.row}>
                <Button
                  label={entry.rating === "up" ? "Liked ✓" : "Liked"}
                  variant="secondary"
                  onPress={() =>
                    updateEntry({
                      id: entry.id,
                ...
                <Button
                  label={
                    entry.rating === "down" ? "Not for me ✓" : "Not for me"
                  }
                  variant="secondary"
                  onPress={() =>
                    updateEntry({
              ...
              {editingId === entry.id ? (
                <>
                  ...
                  <View style={nativeStyles.row}>
                    <Button
                      label="Save note"
                      onPress={() => {
                        updateEntry({ id: entry.id, comment: comment.trim() });
                        setEditingId(null);
                      }}
                    />
                    <Button
                ...
                <Pressable
                  accessibilityRole="button"
                  accessibilityLabel={
                    entry.comment ? `Edit note. ${entry.comment}` : "Add a note"
                  }
                ...
                >
                  <Text
                    style={entry.comment ? styles.comment : nativeStyles.muted}
                  >
