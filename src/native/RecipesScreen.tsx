...
const styles = StyleSheet.create({ recipeTitle: { fontSize: 19, color: colors.espresso, fontWeight: "700" }, meta: { color: colors.saffronDeep, fontWeight: "600" }, detailTitle: { fontSize: 32, lineHeight: 38, fontWeight: "700", color: colors.espresso }, description: { color: colors.stone700, fontSize: 17, lineHeight: 25 }, line: { flexDirection: "row", gap: 10, alignItems: "flex-start", paddingVertical: 5 }, bullet: { color: colors.saffronDeep, fontSize: 22 }, step: { width: 28, height: 28, borderRadius: 14, overflow: "hidden", textAlign: "center", paddingTop: 4, backgroundColor: colors.saffronTint, color: colors.saffronDeep, fontWeight: "700" }, lineText: { flex: 1, color: colors.espresso, fontSize: 16, lineHeight: 24 }, preview: { gap: 8, padding: 12, backgroundColor: colors.saffronTint, borderRadius: 12 } });
