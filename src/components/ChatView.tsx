    ...
    (index: number) => {
      ...
      void toast
        .ask({
          ...
          message: "Editing this message will remove all later replies.",
                    ...
                    {msg.role === "assistant" ? (
                      ...
                      <div style={styles.userEditBubble}>
                        ...
                        <div style={styles.userEditActions}>
                          <button
                            type="button"
                            style={styles.userEditCancelBtn}
                          ...
                          <button
                            ...
                            onClick={() => handleSaveEditedMessage(i)}
                          >
                            Save & Regenerate
                          </button>
                        </div>
                      ...
                      <div style={styles.userMessageColumn}>
                        ...
                        {!isStreaming && msg.content && (
                          <button
                            ...
                            onClick={() =>
                              handleStartEditMessage(i, msg.content)
                            }
                          >
                            Edit
                          </button>
...
function renderInputArea(
  ...
  const sendDisabled =
    !isStreaming &&
    ((!inputValue.trim() && !imageAttachment) || isPreparingImage);
  return (
