...
export const shadows = {
    glass: "0 1px 2px rgba(40, 25, 15, 0.04), 0 8px 24px -8px rgba(40, 25, 15, 0.08)",
    glassLg: "0 2px 4px rgba(40, 25, 15, 0.05), 0 12px 32px -12px rgba(40, 25, 15, 0.12)",
    glassXl: "0 4px 6px rgba(40, 25, 15, 0.06), 0 16px 40px -16px rgba(40, 25, 15, 0.15)",
} as const;
